...
declare rcline='export PYTHON_BUILD_ARIA2_OPTS="-x 10 -k 1M"export PATH="$HOME/.pyenv/bin:$PATH"eval "$(pyenv init --path)"eval "$(pyenv init -)"eval "$(pyenv virtualenv-init -)"';
